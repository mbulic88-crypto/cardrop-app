...
const translations = {
  ...
  de: {
    pageTitle: "Parkplatz hinzufügen",
    pageSubtitle: "Füllen Sie die Informationen über Ihren Parkplatz aus und beginnen Sie zu verdienen",
    homeButton: "Startseite",
    title: "Titel",
    titlePlaceholder: "z.B. Parkplatz im Stadtzentrum",
    description: "Beschreibung",
    descriptionPlaceholder: "Detaillierte Beschreibung Ihres Parkplatzes",
    address: "Adresse",
    ...
    phonePlaceholder: "+381 64 123 4567",
    phoneDescription: "Telefon für den Kontakt mit Mietern",
    contactEmail: "Kontakt-E-Mail",
    emailPlaceholder: "beispiel@email.com",
    emailDescription: "E-Mail für Kontakt und Bestätigungen",
    latitude: "Breitengrad",
    longitude: "Längengrad",
    coordinatesDescription: "Automatisch basierend auf der Adresse ausgefüllt",
    price: "Preis pro Stunde",
    pricePlaceholder: "200",
    priceDescription: "Preis pro Stunde Parken",
    currency: "Währung",
    paymentType: "Zahlungsart",
    paymentCash: "Bargeld",
    paymentBankTransfer: "Banküberweisung",
    spotType: "Parkplatztyp",
    spotUncovered: "Offen",
    spotCovered: "Überdacht",
    spotGarage: "Garage",
    evCharging: "EV-Ladegerät",
    evChargingDescription: "Haben Sie ein EV-Ladegerät?",
    securityCamera: "Sicherheitskamera",
    securityCameraDescription: "Ist der Bereich videoüberwacht?",
    available24h: "24/7 verfügbar",
    available24hDescription: "Ist der Parkplatz rund um die Uhr verfügbar?",
    additionalOptions: "Zusätzliche Optionen",
    subscriptionPrice: "Abonnementpreis",
    subscriptionAmount: "1.000 RSD + Stripe-Gebühr",
    subscriptionDuration: "Ihr Parkplatz wird 30 Tage veröffentlicht",
    submitButton: "Parkplatz hinzufügen",
    submittingButton: "Hinzufügen...",
    imageUploadTitle: "Parkplatzbilder hinzufügen",
    imageUploadDescription: "Fügen Sie bis zu 5 Bilder Ihres Parkplatzes hinzu, um mehr Nutzer anzulocken.",
    uploadButton: "Bilder hinzufügen",
    finishButton: "Fertig",
    successTitle: "Erfolgreich hinzugefügt",
    successDescription: "Sie können jetzt Bilder des Parkplatzes hinzufügen oder auf Fertig klicken.",
    loginRequired: "Zum Hinzufügen eines Parkplatzes ist eine Anmeldung erforderlich.",
    companyName: "Firmenname",
    companyNamePlaceholder: "z.B. Parking GmbH",
    pib: "Steuer-ID (PIB)",
    pibPlaceholder: "123456789",
    numberOfSpots: "Anzahl der Parkplätze",
    numberOfSpotsPlaceholder: "5",
    numberOfSpotsDescription: "Wie viele Parkplätze vermieten Sie",
    autoRenewal: "Automatische Verlängerung",
    autoRenewalDescription: "Abonnement automatisch verlängern wenn es abläuft",
    truckPageTitle: "Werben Sie für Ihren LKW-Halteplatz",
    truckPageSubtitle: "Füllen Sie die Informationen über Ihren Halteplatz aus und beginnen Sie zu verdienen",
    pricePerDay: "Preis pro Tag",
    pricePerDayPlaceholder: "1000",
    pricePerDayDescription: "Preis pro Tag Parken",
    truckPib: "Firmen Steuer-ID (PIB)",
    truckPibPlaceholder: "123456789",
    truckPibDescription: "Steueridentifikationsnummer (optional)",
    residentialPageTitle: "Parkplatz der Wohngemeinschaft bewerben",
    residentialPageSubtitle: "Füllen Sie die Informationen über den Parkplatz Ihrer Wohngemeinschaft aus",
    contactPerson: "Kontaktperson",
    contactPersonPlaceholder: "Vollständiger Name",
    contactPersonDescription: "Kontaktperson in der Wohngemeinschaft",
    residentialPib: "Steuer-ID (optional)",
    residentialPibPlaceholder: "123456789",
    residentialPibDescription: "Steueridentifikationsnummer der Gemeinschaft",
    advertiserType: "Werbetreibender",
    advertiserOwner: "Eigentümer",
    advertiserAgency: "Agentur",
    advertiserCompany: "Unternehmen",
    rentalDuration: "Miettyp",
    rentalDurationDescription: "Wählen Sie Kurz- oder Langzeitmiete",
    rentalShortTerm: "Kurzfristig",
    rentalLongTerm: "Langfristig",
    pricingPeriod: "Abrechnungszeitraum",
    pricingPeriodDescription: "Wählen Sie den Abrechnungszeitraum",
    pricingHourly: "Pro Stunde",
    pricingDaily: "Pro Tag",
    pricingWeekly: "Pro Woche",
    pricingMonthly: "Pro Monat",
    pricePerHourLabel: "Preis pro Stunde",
    pricePerHourPlaceholder: "200",
    pricePerHourDescription: "Stundenparkpreis",
    pricePerDayLabel: "Preis pro Tag",
    pricePerDayLabelPlaceholder: "1000",
    pricePerDayLabelDescription: "Tagesparkpreis",
    pricePerWeek: "Preis pro Woche",
    pricePerWeekPlaceholder: "3000",
    pricePerWeekDescription: "Wochenparkpreis",
    pricePerMonth: "Preis pro Monat",
    pricePerMonthPlaceholder: "5000",
    pricePerMonthDescription: "Monatsparkpreis",
  },
  hu: {
    pageTitle: "Parkolóhely hozzáadása",
    pageSubtitle: "Töltse ki a parkolóhelyéről szóló információkat és kezdjen el keresni",
    homeButton: "Főoldal",
    title: "Cím",
    titlePlaceholder: "pl. Parkolóhely a belvárosban",
    description: "Leírás",
    descriptionPlaceholder: "A parkolóhely részletes leírása",
    address: "Cím",
    ...
    phonePlaceholder: "+381 64 123 4567",
    phoneDescription: "Telefon a bérlőkkel való kapcsolattartáshoz",
    contactEmail: "Kapcsolattartó e-mail",
    emailPlaceholder: "pelda@email.com",
    emailDescription: "E-mail kapcsolattartáshoz és megerősítésekhez",
    latitude: "Szélességi fok",
    longitude: "Hosszúsági fok",
    coordinatesDescription: "Automatikusan kitöltve a cím alapján",
    price: "Óránkénti ár",
    pricePlaceholder: "200",
    priceDescription: "Parkolás óránkénti ára",
    currency: "Pénznem",
    paymentType: "Fizetési mód",
    paymentCash: "Készpénz",
    paymentBankTransfer: "Banki átutalás",
    spotType: "Parkolóhely típusa",
    spotUncovered: "Fedetlen",
    spotCovered: "Fedett",
    spotGarage: "Garázs",
    evCharging: "EV töltő",
    evChargingDescription: "Van EV töltője?",
    securityCamera: "Biztonsági kamera",
    securityCameraDescription: "A terület videómegfigyelés alatt áll?",
    available24h: "0-24 elérhető",
    available24hDescription: "A parkolóhely non-stop elérhető?",
    additionalOptions: "További opciók",
    subscriptionPrice: "Előfizetési ár",
    subscriptionAmount: "1.000 RSD + Stripe díj",
    subscriptionDuration: "Parkolóhelye 30 napig lesz közzétéve",
    submitButton: "Parkolóhely hozzáadása",
    submittingButton: "Hozzáadás...",
    imageUploadTitle: "Parkolóhely képek hozzáadása",
    imageUploadDescription: "Adjon hozzá legfeljebb 5 képet a parkolóhelyéről, hogy több felhasználót vonzzon.",
    uploadButton: "Képek hozzáadása",
    finishButton: "Befejezés",
    successTitle: "Sikeresen hozzáadva",
    successDescription: "Most képeket adhat hozzá a parkolóhelyhez, vagy kattintson a Befejezés gombra.",
    loginRequired: "Parkolóhely hozzáadásához bejelentkezés szükséges.",
    companyName: "Cégnév",
    companyNamePlaceholder: "pl. Parking Kft.",
    pib: "Adószám (PIB)",
    pibPlaceholder: "123456789",
    numberOfSpots: "Parkolóhelyek száma",
    numberOfSpotsPlaceholder: "5",
    numberOfSpotsDescription: "Hány parkolóhelyet ad bérbe",
    autoRenewal: "Automatikus megújítás",
    autoRenewalDescription: "Előfizetés automatikus megújítása lejáratkor",
    truckPageTitle: "Hirdesse kamionmegállóját",
    truckPageSubtitle: "Töltse ki a kamionmegállóról szóló információkat és kezdjen el keresni",
    pricePerDay: "Napi ár",
    pricePerDayPlaceholder: "1000",
    pricePerDayDescription: "Napi parkolási ár",
    truckPib: "Céges adószám (PIB)",
    truckPibPlaceholder: "123456789",
    truckPibDescription: "Adóazonosító szám (opcionális)",
    residentialPageTitle: "Lakóközösségi parkoló hirdetése",
    residentialPageSubtitle: "Töltse ki a lakóközösségi parkolóról szóló információkat",
    contactPerson: "Kapcsolattartó személy",
    contactPersonPlaceholder: "Teljes név",
    contactPersonDescription: "Kapcsolattartó személy a lakóközösségben",
    residentialPib: "Adószám (opcionális)",
    residentialPibPlaceholder: "123456789",
    residentialPibDescription: "A közösség adóazonosító száma",
    advertiserType: "Hirdető",
    advertiserOwner: "Tulajdonos",
    advertiserAgency: "Ügynökség",
    advertiserCompany: "Vállalat",
    rentalDuration: "Bérleti típus",
    rentalDurationDescription: "Válasszon rövid- vagy hosszú távú bérletet",
    rentalShortTerm: "Rövid távú",
    rentalLongTerm: "Hosszú távú",
    pricingPeriod: "Számlázási időszak",
    pricingPeriodDescription: "Válassza ki a számlázási időszakot",
    pricingHourly: "Óránként",
    pricingDaily: "Naponta",
    pricingWeekly: "Hetente",
    pricingMonthly: "Havonta",
    pricePerHourLabel: "Óránkénti ár",
    pricePerHourPlaceholder: "200",
    pricePerHourDescription: "Óránkénti parkolási ár",
    pricePerDayLabel: "Napi ár",
    pricePerDayLabelPlaceholder: "1000",
    pricePerDayLabelDescription: "Napi parkolási ár",
    pricePerWeek: "Heti ár",
    pricePerWeekPlaceholder: "3000",
    pricePerWeekDescription: "Heti parkolási ár",
    pricePerMonth: "Havi ár",
    pricePerMonthPlaceholder: "5000",
    pricePerMonthDescription: "Havi parkolási ár",
  },
  sk: {
    pageTitle: "Pridať parkovacie miesto",
    pageSubtitle: "Vyplňte informácie o vašom parkovacom mieste a začnite zarábať",
    homeButton: "Domov",
    title: "Názov",
    titlePlaceholder: "napr. Parkovanie v centre mesta",
    description: "Popis",
    descriptionPlaceholder: "Podrobný popis vášho parkovacieho miesta",
    address: "Adresa",
    ...
    cityOptional: "(voliteľné)",
    contactPhone: "Kontaktný telefón",
    phonePlaceholder: "+381 64 123 4567",
    phoneDescription: "Telefón na kontakt s nájomcami",
    contactEmail: "Kontaktný e-mail",
    emailPlaceholder: "priklad@email.com",
    emailDescription: "E-mail na kontakt a potvrdenia",
    latitude: "Zemepisná šírka",
    longitude: "Zemepisná dĺžka",
    coordinatesDescription: "Automaticky vyplnené na základe adresy",
    price: "Cena za hodinu",
    pricePlaceholder: "200",
    priceDescription: "Cena za hodinu parkovania",
    currency: "Mena",
    paymentType: "Typ platby",
    paymentCash: "Hotovosť",
    paymentBankTransfer: "Bankový prevod",
    spotType: "Typ parkovacieho miesta",
    spotUncovered: "Otvorené",
    spotCovered: "Kryté",
    spotGarage: "Garáž",
    evCharging: "EV nabíjačka",
    evChargingDescription: "Máte EV nabíjačku?",
    securityCamera: "Bezpečnostná kamera",
    securityCameraDescription: "Je priestor pod video dohľadom?",
    available24h: "Dostupné 24/7",
    available24hDescription: "Je parkovacie miesto dostupné non-stop?",
    additionalOptions: "Ďalšie možnosti",
    subscriptionPrice: "Cena predplatného",
    subscriptionAmount: "1 000 RSD + poplatok Stripe",
    subscriptionDuration: "Vaše parkovacie miesto bude zverejnené 30 dní",
    submitButton: "Pridať parkovacie miesto",
    submittingButton: "Pridávanie...",
    imageUploadTitle: "Pridať obrázky parkovacieho miesta",
    imageUploadDescription: "Pridajte až 5 obrázkov vášho parkovacieho miesta na prilákanie viac používateľov.",
    uploadButton: "Pridať obrázky",
    finishButton: "Dokončiť",
    successTitle: "Úspešne pridané",
    successDescription: "Teraz môžete pridať obrázky parkovacieho miesta alebo kliknúť Dokončiť.",
    loginRequired: "Na pridanie parkovacieho miesta je potrebné prihlásenie.",
    companyName: "Názov firmy",
    companyNamePlaceholder: "napr. Parking s.r.o.",
    pib: "DIČ (PIB)",
    pibPlaceholder: "123456789",
    numberOfSpots: "Počet parkovacích miest",
    numberOfSpotsPlaceholder: "5",
    numberOfSpotsDescription: "Koľko parkovacích miest prenajímate",
    autoRenewal: "Automatické obnovenie",
    autoRenewalDescription: "Automaticky obnoviť predplatné po vypršaní",
    truckPageTitle: "Inzerujte vašu zastávku pre kamióny",
    truckPageSubtitle: "Vyplňte informácie o vašej zastávke a začnite zarábať",
    pricePerDay: "Cena za deň",
    pricePerDayPlaceholder: "1000",
    pricePerDayDescription: "Cena za deň parkovania",
    truckPib: "Firemné DIČ (PIB)",
    truckPibPlaceholder: "123456789",
    truckPibDescription: "Daňové identifikačné číslo (voliteľné)",
    residentialPageTitle: "Inzerujte parkovanie bytového spoločenstva",
    residentialPageSubtitle: "Vyplňte informácie o parkovaní vášho bytového spoločenstva",
    contactPerson: "Kontaktná osoba",
    contactPersonPlaceholder: "Celé meno",
    contactPersonDescription: "Kontaktná osoba v bytovom spoločenstve",
    residentialPib: "DIČ (voliteľné)",
    residentialPibPlaceholder: "123456789",
    residentialPibDescription: "Daňové identifikačné číslo spoločenstva",
    advertiserType: "Inzerent",
    advertiserOwner: "Vlastník",
    advertiserAgency: "Agentúra",
    advertiserCompany: "Spoločnosť",
    rentalDuration: "Typ prenájmu",
    rentalDurationDescription: "Vyberte krátkodobý alebo dlhodobý prenájom",
    rentalShortTerm: "Krátkodobý",
    rentalLongTerm: "Dlhodobý",
    pricingPeriod: "Fakturačné obdobie",
    pricingPeriodDescription: "Vyberte fakturačné obdobie",
    pricingHourly: "Za hodinu",
    pricingDaily: "Za deň",
    pricingWeekly: "Za týždeň",
    pricingMonthly: "Za mesiac",
    pricePerHourLabel: "Cena za hodinu",
    pricePerHourPlaceholder: "200",
    pricePerHourDescription: "Hodinová cena parkovania",
    pricePerDayLabel: "Cena za deň",
    pricePerDayLabelPlaceholder: "1000",
    pricePerDayLabelDescription: "Denná cena parkovania",
    pricePerWeek: "Cena za týždeň",
    pricePerWeekPlaceholder: "3000",
    pricePerWeekDescription: "Týždenná cena parkovania",
    pricePerMonth: "Cena za mesiac",
    pricePerMonthPlaceholder: "5000",
    pricePerMonthDescription: "Mesačná cena parkovania",
  },
  mk: {
    pageTitle: "Додадете паркинг место",
    pageSubtitle: "Пополнете ги информациите за вашето паркинг место и почнете да заработувате",
    homeButton: "Почетна",
    title: "Наслов",
    titlePlaceholder: "пр. Паркинг во центарот на градот",
    description: "Опис",
    descriptionPlaceholder: "Детален опис на вашето паркинг место",
    address: "Адреса",
    ...
    cityOptional: "(опционално)",
    contactPhone: "Контакт телефон",
    phonePlaceholder: "+381 64 123 4567",
    phoneDescription: "Телефон за контакт со изнајмувачите",
    contactEmail: "Контакт е-пошта",
    emailPlaceholder: "primer@email.com",
    emailDescription: "Е-пошта за контакт и потврди",
    latitude: "Географска ширина",
    longitude: "Географска должина",
    coordinatesDescription: "Автоматски пополнето врз основа на адресата",
    price: "Цена по час",
    pricePlaceholder: "200",
    priceDescription: "Цена по час паркирање",
    currency: "Валута",
    paymentType: "Тип на плаќање",
    paymentCash: "Готовина",
    paymentBankTransfer: "Банкарски трансфер",
    spotType: "Тип на паркинг место",
    spotUncovered: "Отворено",
    spotCovered: "Покриено",
    spotGarage: "Гаража",
    evCharging: "EV полнач",
    evChargingDescription: "Дали имате EV полнач?",
    securityCamera: "Безбедносна камера",
    securityCameraDescription: "Дали просторот е под видео надзор?",
    available24h: "Достапно 24/7",
    available24hDescription: "Дали паркинг местото е достапно нон-стоп?",
    additionalOptions: "Дополнителни опции",
    subscriptionPrice: "Цена на претплата",
    subscriptionAmount: "1.000 RSD + Stripe провизија",
    subscriptionDuration: "Вашето паркинг место ќе биде објавено 30 дена",
    submitButton: "Додадете паркинг место",
    submittingButton: "Додавање...",
    imageUploadTitle: "Додадете слики на паркинг место",
    imageUploadDescription: "Додадете до 5 слики на вашето паркинг место за да привлечете повеќе корисници.",
    uploadButton: "Додадете слики",
    finishButton: "Заврши",
    successTitle: "Успешно додадено",
    successDescription: "Сега можете да додадете слики на паркинг местото или кликнете Заврши.",
    loginRequired: "За додавање паркинг место потребна е најава на сметка.",
    companyName: "Име на фирма",
    companyNamePlaceholder: "пр. Паркинг ДООЕЛ",
    pib: "ЕДБ (PIB)",
    pibPlaceholder: "123456789",
    numberOfSpots: "Број на паркинг места",
    numberOfSpotsPlaceholder: "5",
    numberOfSpotsDescription: "Колку паркинг места изнајмувате",
    autoRenewal: "Автоматско обновување",
    autoRenewalDescription: "Автоматски продолжете ја претплатата кога истечува",
    truckPageTitle: "Огласете го вашето стојалиште за камиони",
    truckPageSubtitle: "Пополнете ги информациите за вашето стојалиште и почнете да заработувате",
    pricePerDay: "Цена по ден",
    pricePerDayPlaceholder: "1000",
    pricePerDayDescription: "Цена по ден паркирање",
    truckPib: "Фирмен ЕДБ (PIB)",
    truckPibPlaceholder: "123456789",
    truckPibDescription: "Даночен идентификационен број (опционално)",
    residentialPageTitle: "Огласете паркинг на станбена заедница",
    residentialPageSubtitle: "Пополнете ги информациите за паркингот на вашата станбена заедница",
    contactPerson: "Контакт лице",
    contactPersonPlaceholder: "Целосно име",
    contactPersonDescription: "Контакт лице во станбената заедница",
    residentialPib: "ЕДБ (опционално)",
    residentialPibPlaceholder: "123456789",
    residentialPibDescription: "Даночен идентификационен број на заедницата",
    advertiserType: "Огласувач",
    advertiserOwner: "Сопственик",
    advertiserAgency: "Агенција",
    advertiserCompany: "Компанија",
    rentalDuration: "Тип на издавање",
    rentalDurationDescription: "Изберете краткорочно или долгорочно",
    rentalShortTerm: "Краткорочно",
    rentalLongTerm: "Долгорочно",
    pricingPeriod: "Период на наплата",
    pricingPeriodDescription: "Изберете период на наплата",
    pricingHourly: "По час",
    pricingDaily: "По ден",
    pricingWeekly: "По недела",
    pricingMonthly: "По месец",
    pricePerHourLabel: "Цена по час",
    pricePerHourPlaceholder: "200",
    pricePerHourDescription: "Часовна цена на паркирање",
    pricePerDayLabel: "Цена по ден",
    pricePerDayLabelPlaceholder: "1000",
    pricePerDayLabelDescription: "Дневна цена на паркирање",
    pricePerWeek: "Цена по недела",
    pricePerWeekPlaceholder: "3000",
    pricePerWeekDescription: "Неделна цена на паркирање",
    pricePerMonth: "Цена по месец",
    pricePerMonthPlaceholder: "5000",
    pricePerMonthDescription: "Месечна цена на паркирање",
  }
};
