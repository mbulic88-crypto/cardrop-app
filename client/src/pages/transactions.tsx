...
import { ArrowLeft, DollarSign, Calendar, MapPin, Download, CreditCard } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-foreground">Istorija Transakcija</h1>
            </div>
          </div>
        </div>
      </header>
