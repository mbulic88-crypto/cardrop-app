import { MapPin, Bell, MessageCircle, Navigation, AlertTriangle, Crosshair, Shield, Zap } from "lucide-react";
    ...
    <div className="relative w-full h-full overflow-hidden" style={{ background: "#0d1117" }}>
      ...
      <svg width="100%" height="100%" style={{ position: "absolute", inset: 0 }}>
        <defs>
          ...
          <pattern id="streets-dark" width="96" height="96" patternUnits="userSpaceOnUse">
            <rect width="96" height="96" fill="url(#grid-dark)" />
            <path d="M 0 48 L 96 48" stroke="#252d3d" strokeWidth="3" />
            <path d="M 48 0 L 48 96" stroke="#252d3d" strokeWidth="3" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#streets-dark)" />
        {/* Zone: pauk crvena */}
      ...
      <div className="absolute" style={{ top: "28%", left: "18%", transform: "translate(-50%,-100%)" }}>
        <div className="flex flex-col items-center">
          <div className="bg-red-500/90 backdrop-blur-sm text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-lg shadow-red-500/40 border border-red-400/30">
            PAUK ZONA
          </div>
      ...
      <div className="absolute" style={{ top: "48%", left: "68%", transform: "translate(-50%,-100%)" }}>
        <div className="flex flex-col items-center">
          <div className="bg-green-500/90 backdrop-blur-sm text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-lg shadow-green-500/40 border border-green-400/30">
            ŠTEK
          </div>
    ...
    <div className="w-full h-screen flex flex-col overflow-hidden" style={{ background: "#080c14", fontFamily: "system-ui" }}>
      ...
      >
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-full overflow-hidden ring-2 ring-green-500/40 flex-shrink-0" style={{ background: "#1a2235" }}>
            <div className="w-full h-full flex items-center justify-center text-green-400 text-xs font-bold">PM</div>
          </div>
          <div>
      ...
      <div className="relative z-20 px-4 pb-6 pt-2">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              onClick={() => setActive("pauk")}
              className="flex flex-col items-center gap-1.5 py-3 rounded-xl transition-all"
              style={{
                background: active === "pauk" ? "rgba(239,68,68,0.25)" : "rgba(239,68,68,0.1)",
                border: `1px solid ${active === "pauk" ? "rgba(239,68,68,0.5)" : "rgba(239,68,68,0.2)"}`,
              }}
            >
            ...
            <button
              ...
              className="flex flex-col items-center gap-1.5 py-3 rounded-xl transition-all"
              style={{
                background: active === "shield" ? "rgba(34,197,94,0.25)" : "rgba(34,197,94,0.1)",
                border: `1px solid ${active === "shield" ? "rgba(34,197,94,0.5)" : "rgba(34,197,94,0.2)"}`,
              }}
            >
              <Shield className="w-4 h-4 text-green-400" />
              <span className="text-green-300 text-[10px] font-semibold">Safe Zone</span>
              <span className="text-green-400/60 text-[9px]">Alarm</span>
            </button>
