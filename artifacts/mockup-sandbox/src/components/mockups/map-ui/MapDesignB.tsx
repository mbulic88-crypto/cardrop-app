import { MapPin, Bell, MessageCircle, AlertTriangle, Navigation, Search } from "lucide-react";

function LightSimMap() {
  return (
    <div className="relative w-full h-full overflow-hidden" style={{ background: "#f0f4f0" }}>
      <svg width="100%" height="100%" style={{ position: "absolute", inset: 0 }}>
        <defs>
          ...
          <pattern id="streets-b" width="80" height="80" patternUnits="userSpaceOnUse">
            <rect width="80" height="80" fill="url(#grid-b)" />
            <path d="M 0 40 L 80 40" stroke="#d4ddd4" strokeWidth="2.5" />
            <path d="M 40 0 L 40 80" stroke="#d4ddd4" strokeWidth="2.5" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#streets-b)" />
...
export function MapDesignB() {
  return (
    <div className="w-full h-screen flex flex-col overflow-hidden bg-white" style={{ fontFamily: "system-ui" }}>

      {/* TOP CARD — compact rounded-2xl shadow-lg */}
      <div className="bg-white px-4 pt-4 pb-3 z-20 relative" style={{ boxShadow: "0 4px 20px rgba(0,0,0,0.08)" }}>
      ...
      {/* MAP — 70% of remaining screen */}
      <div className="flex-1 relative" style={{ flex: "0 0 70%", maxHeight: "70%" }}>
        <LightSimMap />
      ...
      <div
        className="flex-1 bg-white border-t border-gray-100 px-4 pt-3 pb-5 z-20 relative"
